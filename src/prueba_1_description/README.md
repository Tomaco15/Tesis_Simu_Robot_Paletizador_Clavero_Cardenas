# Visualizar prueba_1 en ROS 2 Humble

Desde la raíz del workspace:

```bash
source /opt/ros/humble/setup.bash
colcon build --symlink-install --packages-select prueba_1_description
source install/setup.bash
ros2 launch prueba_1_description display.launch.py
```
...
Los rangos están definidos en `urdf/prueba_1.xacro` y se tomaron del modelo
